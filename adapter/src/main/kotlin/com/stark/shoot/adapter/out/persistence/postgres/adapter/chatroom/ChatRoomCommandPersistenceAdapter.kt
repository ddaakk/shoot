...
class ChatRoomCommandPersistenceAdapter(
    ...
    private fun saveInternal(chatRoom: ChatRoom): ChatRoom {
        ...
        val savedChatRoomEntity = if (chatRoomId != null) {
            val existingEntity = chatRoomRepository.findById(chatRoomId.value).orElseThrow {
                IllegalStateException("채팅방을 찾을 수 없습니다. id=$chatRoomId")
            }
