...
class FriendGroupCommandPersistenceAdapter(
    ...
    override fun save(group: FriendGroup): FriendGroup {
        ...
        val entity: FriendGroupEntity = if (groupId != null) {
            val existing = groupRepository.findById(groupId.value)
                .orElseThrow { ResourceNotFoundException("그룹을 찾을 수 없습니다: $groupId") }
