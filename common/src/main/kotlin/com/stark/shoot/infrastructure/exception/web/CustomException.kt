...
class UserNotInRoomException(message: String) : RuntimeException(message)
class WebSocketException(message: String) : RuntimeException(message)
class InvalidInputException(message: String) : RuntimeException(message)
class ResourceNotFoundException(message: String) : RuntimeException(message)
class ScheduledMessageNotOwnedException(message: String) : RuntimeException(message)
class ScheduledMessageAlreadyProcessedException(message: String) : RuntimeException(message)
