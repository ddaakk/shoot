...
interface FindChatRoomUseCase {
     ...
     */
    fun getChatRoomsForUser(command: GetChatRoomsCommand): List<ChatRoomResponseDto>
     ...
     */
    fun findDirectChatBetweenUsers(command: FindDirectChatCommand): ChatRoomResponseDto?
}
